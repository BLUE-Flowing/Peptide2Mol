...
def pdb_to_sdf(pdb_file, sdf_file):
    ...
    # Create an RDKit molecule from PDB content
    mol = Chem.MolFromPDBBlock(pdb_content)
    if mol is None:
        raise ValueError("Failed to parse PDB file into a molecule.")

    # Optionally, you can generate 3D coordinates if needed
